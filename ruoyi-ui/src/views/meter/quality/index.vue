<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="A相电压THD" align="center" min-width="120">
        <template slot-scope="scope">{{ formatNumber(scope.row.voltageThdA) }} %</template>
      </el-table-column>
      <el-table-column label="B相电压THD" align="center" min-width="120">
        <template slot-scope="scope">{{ formatNumber(scope.row.voltageThdB) }} %</template>
      </el-table-column>
      <el-table-column label="C相电压THD" align="center" min-width="120">
        <template slot-scope="scope">{{ formatNumber(scope.row.voltageThdC) }} %</template>
      </el-table-column>
