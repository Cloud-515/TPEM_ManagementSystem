...
namespace MeterAcquisition.HeatPump.Forms
{
    internal sealed partial class HeatPumpMonitorControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            _analysisPanel.Dock = DockStyle.Fill; _analysisPanel.ColumnCount = 2; _analysisPanel.RowCount = 4; _analysisPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 228F)); _analysisPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 100F)); _analysisPanel.RowStyles.Add(new RowStyle(SizeType.Absolute, 86F)); _analysisPanel.RowStyles.Add(new RowStyle(SizeType.Absolute, 48F)); _analysisPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 100F)); _analysisPanel.RowStyles.Add(new RowStyle(SizeType.Absolute, 180F)); _analysisPanel.Controls.Add(_filterPanel, 0, 0); _analysisPanel.SetColumnSpan(_filterPanel, 2); _analysisPanel.Controls.Add(_summaryLabel, 0, 1); _analysisPanel.SetColumnSpan(_summaryLabel, 2); _analysisPanel.Controls.Add(_comparisonPanel, 0, 2); _analysisPanel.Controls.Add(_chartPanel, 1, 2); _analysisPanel.Controls.Add(_eventPanel, 0, 3); _analysisPanel.SetColumnSpan(_eventPanel, 2);
