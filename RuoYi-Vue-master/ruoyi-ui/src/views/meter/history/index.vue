<template>
  <div class="app-container history-page">
    <section class="page-heading">
      <div><h2>历史追溯</h2><p>选择设备与时间范围，查看原始采样记录及变化趋势</p></div>
    </section>
